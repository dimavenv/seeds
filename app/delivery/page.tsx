      ...
      <div className="card mx-auto max-w-3xl p-8">
        ...
        <div className="mt-5 space-y-4 leading-relaxed text-brand-700">
          ...
          <ul className="list-disc space-y-2 pl-5">
            ...
            <li>
              <strong>Ozon</strong> — доставка до пункта выдачи или до двери,
              срок 2–7 дней.
            </li>
          </ul>
          <p>
            <strong>Стоимость доставки фиксированная — 300 ₽</strong> по всей
            России, независимо от выбранного способа (Ozon или Почта России).
          </p>
          <p>
