...
//
// Раньше здесь был authRefresh. Текущая проверка подходит и для обычных
// парольных сессий, и для ранее выданных статических токенов. Проверок это не
// ослабляет: свежая запись пользователя всё равно читается из базы.
