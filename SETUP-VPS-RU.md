...
платёжных сервисов к сайту (RSA ≥ 2048, SHA-256, доверенный УЦ).
...
3. На сайте: политика обработки ПД (страница `/privacy` уже есть — проверьте
   ...
   доставки/возврата. Это же потребует Robokassa при модерации магазина.
...
подключение оплаты (Robokassa: карты, СБП, онлайн-касса по 54-ФЗ).
